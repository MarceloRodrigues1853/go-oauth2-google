...
![Tela inicial da aplicação com botão de Entrar com Google](google/assets/img/tentativa_login_com_google.png)

![Tela do Google informando erro 401 de client inválido](google/assets/img/falha_login_google.png)
...
![Menu do Google Cloud para criar ID do cliente OAuth](google/assets/img/criacao_credencial.png)

![Seleção de Aplicativo da Web no painel](google/assets/img/selecao_tipo_chave.png)

![Preenchimento das URIs de redirecionamento autorizadas](google/assets/img/preencher_campos_obrigatorios_criar.png)
...
![Tela do Google pedindo para escolher qual conta usar](google/assets/img/escolha_da_conta_acesso.png)

![Tela de consentimento informando quais dados serão acessados](google/assets/img/permitir_acesso_chave-app_test.png)
